...
const Home = () => {
  return (
    <div className="text-white flex w-full justify-between items-start p-10 md:p-20">
      ...
      <h1 className="text-3xl md:text-6xl font-bold flex leading-normal tracking-tighter">Hello' Iam kamala Bhatta</h1>

      <p className="text-sm md:text-2xl tracking-tight">Lorem ipsum dolor sit amet consectetur adipisicing elit. Iure, magni totam. Quae totamsuscipit?</p>
